...
[id="comparing-java-util-concurrent-concurrentmap-and-javax-cache-cache-apis_{context}"]
= Comparing java.util.concurrent.ConcurrentMap and javax.cache.Cache APIs
:context: comparing-java-util-concurrent-concurrentmap-and-javax-cache-cache-apis
...
[table,tablepcwidth="100",rowcount="11",header-option="",colcount="3"]
|===
...
[table,tablepcwidth="100",rowcount="6",header-option="",colcount="3"]
|===
